                ...
                widget.updateSliderForDirection = function(direction, splitPos) {
                    ...
                    switch(direction) {
                        ...
                        case 'diagonal':
                            ...
                            // Make the line long enough to span the entire diagonal
                            // For a 500x320 container, diagonal length is approximately sqrt(500² + 320²) ≈ 592px
                            // Using a generous 200px length to ensure it spans the visible area
                            this.sliderHandle.style.width = "200px";
                            this.sliderHandle.style.height = "4px";
                            this.sliderHandle.style.borderRadius = "0";
                            ...
                            // Rotate -45 degrees for top-left to bottom-right diagonal
