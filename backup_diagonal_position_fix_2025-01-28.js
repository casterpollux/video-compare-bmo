                ...
                widget.updateSliderForDirection = function(direction, splitPos) {
                    ...
                    switch(direction) {
                        ...
                        case 'diagonal':
                            ...
                            // For the line x + y = linePosition, find the midpoint
                            let handleX, handleY;
                            if (linePosition <= 100) {
                                // Midpoint of line segment from (0, linePosition) to (linePosition, 0)
                                handleX = linePosition / 2;
                                handleY = linePosition / 2;
                            } else {
                                // Midpoint of line segment from (linePosition-100, 100) to (100, linePosition-100)
                                const adjustedPos = linePosition - 100;
                                handleX = (adjustedPos + 100) / 2;
                                handleY = (100 + adjustedPos) / 2;
                            }
